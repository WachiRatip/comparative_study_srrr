...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanLowranLowdimFGNstructures.csv", sep="-")
...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanLowranLowdimFGNstructuresMEAN.csv", sep="-")
write.csv(df.mean, save.path, row.names = FALSE)
colnames(df.sd) <- c("model", "sdMSE", "sdSPEC", "sdSENS")
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanLowranLowdimFGNstructuresSD.csv", sep="-")
