...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanFullrankLowdimFGNstructures.csv", sep="-")
...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanFullrankLowdimFGNstructuresMEAN.csv", sep="-")
write.csv(df.mean, save.path, row.names = FALSE)
colnames(df.sd) <- c("model", "sdMSE", "sdSPEC", "sdSENS")
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanFullrankLowdimFGNstructuresSD.csv", sep="-")
