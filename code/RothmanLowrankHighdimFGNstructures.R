...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanLowrankHighdimFGNstructures.csv", sep="-")
...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanLowrankHighdimFGNstructuresMEAN.csv", sep="-")
write.csv(df.mean, save.path, row.names = FALSE)
colnames(df.sd) <- c("model", "sdMSE", "sdSPEC", "sdSENS")
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,hurst,"RothmanLowrankHighdimFGNstructuresSD.csv", sep="-")
