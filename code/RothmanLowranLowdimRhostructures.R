...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,rho.e,"RothmanLowranLowdimRhostructures.csv", sep="-")
...
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,rho.e,"RothmanLowranLowdimRhostructuresMEAN.csv", sep="-")
write.csv(df.mean, save.path, row.names = FALSE)
colnames(df.sd) <- c("model", "sdMSE", "sdSPEC", "sdSENS")
save.path <- paste(n,p,q,r,bprob.V,bprob.W,rho.x,rho.e,"RothmanLowranLowdimRhostructuresSD.csv", sep="-")
